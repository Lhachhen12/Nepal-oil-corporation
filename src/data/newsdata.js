...
export const newsData = {
  ...
  press: [
    ...
    },
    {
      ...
      date: "8 Feb 2024", // Updated date
      category: "press",
      status: "active"
    },
    // ... more press news items
  ],
  notices: [
    {
      id: "NT001",
    ...
    },
    {
      ...
      date: "25 Dec 2023", // Updated date
      category: "notice",
      status: "active"
    },
    // ... more notice items
  ],
  notFound: { // Replaced with a real news item
    id: "NF001",
    title: "नेपालमा वन्यजन्तु संरक्षण",
    content: "नेपालमा वन्यजन्तु संरक्षणका लागि विभिन्न कार्यक्रमहरू संचालन भइरहेका छन्।",
    date: "17 Feb 2024", // Updated date
    category: "not-found", // New category for "not found" news
    status: "active"
  }
};